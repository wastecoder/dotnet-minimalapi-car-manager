...
public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapPost("/administrators/login", (LoginDTO loginDTO, IAdministratorService service) =>
            {
            ...
            endpoints.MapPost("/administrators", ([FromBody] AdministratorDTO administratorDto, IAdministratorService service) =>
            {
            ...
            endpoints.MapGet("/administrators", ([FromQuery] int? page, IAdministratorService service) =>
            {
            ...
            endpoints.MapGet("/administrators/{id:int}", ([FromRoute] int id, IAdministratorService service) =>
            {
